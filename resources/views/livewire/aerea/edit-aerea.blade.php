                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div wire:ignore class="form-group">
                                            <p for="">Producto: {{ $producto }}</p>
                                            <select class="my-select" data-width="100%" title="Seleccionar.."
                                                wire:model="producto" id="producto" data-live-search="true">
        ...
        Livewire.on('deleteRegistro', idRegistro => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('aerea.edit-aerea', 'delete', idRegistro);
                }
            })
        })

        $(document).ready(function() {
            var carga = @json($carga);
            var proveedor = @json($proveedor);
            var cliente = @json($cliente);
            $('#carga').val(carga);
            $('#carga').trigger('change');
