    ...
    function RefrescaProducto() {
        ...
        function agregarProducto() {
            ...
            $('.remove-item').off().click(function(e) {
                ...
                total.innerHTML = parseFloat(total.innerHTML) - parseFloat(this.parentNode.parentNode.childNodes[5].childNodes[0].value);
        ...
        function Calcular(ele) {
            var cantidad = 0, precunit = 0, totalitem = 0, nose=0, vol=0, cartones=0 ;
