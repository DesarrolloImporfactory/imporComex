                ...
                <div class="card-footer">
                    ...
                    <form action="{{ route('validacion.store') }}" method="POST" id="formularioCotizacion">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <div class="gastos_local"></div>
                                    <input type="text" name="gastos_local" id="gastos_local" value="{{ $cotizacion->gastos_exw }}" class="form-control"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <div class="flete"></div>
                                    <input type="text" name="flete" id="flete" value="" class="form-control"
                                        readonly>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function icono() {
                ...
                if (logistica > 0) {
                    $(".logistica").prepend(`
            <i class="fa-solid fa-check text-teal"></i> <label for="">Gastos origen: </label>
            `);
                } else {
                    $(".logistica").prepend(`
            <i class="fa-regular fa-circle-xmark text-danger"></i> <label for="">Gastos origen: </label>
            `);
                }

                var gastos_local = $("#gastos_local").val();
                if (gastos_local > 0) {
                    $(".gastos_local").prepend(`
            <i class="fa-solid fa-check text-teal"></i> <label for="">Gastos local: </label>
            `);
                } else {
                    $(".gastos_local").prepend(`
            <i class="fa-regular fa-circle-xmark text-danger"></i> <label for="">Gastos local: </label>
            `);
                }
                ...
                if (flete > 0) {
                    $(".flete").prepend(`
            <i class="fa-solid fa-check text-teal"></i> <label for="">Flete internacional: </label>
            `);
                } else {
                    $(".flete").prepend(`
            <i class="fa-regular fa-circle-xmark text-danger"></i> <label for="">Flete internacional: </label>
            `);
                }
                //
            ...
            function fetchProducts() {
                ...
                $.ajax({
                 ...
                 `);
                        ...
                        var gastos_local = $("#gastos_local").val();
                        $("#flete").val(parseFloat(logistica)+ parseFloat(gastos_local));
