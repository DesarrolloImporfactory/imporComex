...
<div class="row">
    <div class="col-md-3">
        ...
        <a class="btn btn-danger float-left btn-sm" href="{{ route('editar.paso1', $cotizacion->id) }}"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
        @endif
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <x-adminlte-button label="Siguiente" theme="dark" icon="fa-solid fa-arrow-right" class="float-right" form="formularioCotizacion" type="sumbit" />
    </div>
</div><br>
{{-- modal editar --}}
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <input style="background:white " id="valor" type="hidden" class="form-control " value="{{ $cotizacion->total_logistica }}" disabled>
                    ...
                    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button title="Detalles" class="btn btn-outline-success" type="button" data-bs-toggle="modal" data-bs-target="#viewLCL"><i class="fa-solid fa-eye fa-bounce" style="color: #20941e;"></i></button>
                                    </div>
                                    @else
                                    @can('admin.calculadoras.cliente')
                                    <div class="input-group-append">
                                        <button title="Detalles" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#editFlete" type="button"><i class="fa-solid fa-pen-to-square fa-beat" style="color: #d71d1d;"></i></button>
                                    </div>
                                    @endcan
                                    @endif
                                </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="cotizacion_total" id="cotizacion_total" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="cantidad_productos" id="productos_total" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
        ...
        <x-adminlte-card title="CALCULEMOS TUS IMPUESTOS" theme="light" icon="fas fa-lg fa-calculator">
            ...
            <div class="row">
                ...
                <div class="row" id="exampleModal">
                    ...
                    <div class="col-md-2 text-center">
                        <label for="">Porcentaje</label>
                        <input type="number" min="0" name="" id="porcentaje" class="form-control" value="{{ old('porcentaje') }}" readonly>
                    </div>
