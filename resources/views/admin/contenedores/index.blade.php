...
@section('content_header')
    ...
    <div class="row">
        <div class="col-md-12">
            <x-adminlte-button class="btn btn-primary float-right" label="Agregar Contenedor" theme="dark" icon="fa-solid fa-plus" data-bs-toggle="modal" data-bs-target="#crearContenedor"/>
